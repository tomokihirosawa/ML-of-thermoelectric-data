...
def train(device, epoch, params, model, optimizer,Tot_epoch,loss_array):
    ...
    if (epoch+1==Tot_epoch):
        ...
        res.tofile('./data/exp_all_cond_'+str(epoch+1)+'_'+str(sample)+'.dat')
        res2.tofile('./data/exp_all_L11_L12_'+str(epoch+1)+'_'+str(sample)+'.dat')
...
if __name__ == '__main__':
    ...
    for epoch in range(hyperparameters.epochs):
        ...
        if epoch%100==0:
            ...
            train(device, epoch, hyperparameters.params, model, optimizer,hyperparameters.epochs,loss_array)        
    loss_array.tofile('./data/exp_all_loss_'+str(epoch+1)+'_'+str(sample)+'.dat')  
